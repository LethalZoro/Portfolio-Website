  ...
  return (
    <div className={`relative mb-12 sm:mb-16 ${className}`}>
      <span
        aria-hidden
        data-index={index}
        className="ghost-numeral font-display pointer-events-none absolute -left-[0.06em] -top-[0.36em] select-none text-[clamp(4.5rem,11vw,8rem)] leading-none text-text opacity-[0.055]"
      />
